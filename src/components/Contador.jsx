...
const Contador = () => {
  ...
  return (
    <div className="flex flex-col items-center mt-6 px-4 font-edu-hand">
      <p className="font-bold text-lg mb-4 text-center bg-[#345798]/25 text-white p-3 rounded-xl border">⏳ Tiempo Restante</p>
      <div className="grid grid-cols-2 sm:flex sm:flex-row gap-3 w-full max-w-md">
        <div className="flex flex-col items-center p-3 bg-[#0f2343]/80 text-white rounded-xl shadow-lg border">
