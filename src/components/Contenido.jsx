...
export default function Contenido() {
  return (<>
    <div className="grid place-items-center text-center font-bold text-[#E3E6F3] mt-16 mx-1 p-8 rounded-2xl shadow-lg bg-[#000D42]/65">
    ...
    <div className="bg-[#0111E1]/40 text-white flex justify-around items-center p-2 rounded-xl m-12 font-ibm">
