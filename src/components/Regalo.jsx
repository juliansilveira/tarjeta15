export default function Regalo() {
  return (
    ...
    >
      <div className="bg-gradient-to-br from-blue-700/30 via-blue-500/30 to-indigo-700/30 backdrop-blur-xl p-[3px] rounded-3xl shadow-2xl border border-blue-200/30 hover:scale-105 transition-all duration-500 w-full max-w-2xl">
        <div className="bg-gradient-to-br from-slate-950/95 via-blue-950/95 to-slate-950/95 rounded-3xl p-8 md:p-10 text-center">
          ...
          <h3 className="text-2xl md:text-3xl font-playfair font-bold bg-gradient-to-r from-blue-100 via-white to-blue-100 bg-clip-text text-transparent mb-6">
            Regalo
          </h3>
          ...
          <div className="bg-gradient-to-br from-blue-700/20 to-blue-600/20 backdrop-blur-sm rounded-2xl p-6 border border-blue-200/20 space-y-4">
            {/* Nombre */}
            <div className="space-y-1">
              <p className="text-blue-100 font-montserrat font-semibold text-xl md:text-2xl">
                Mía Sanchez Silveira
              </p>
            </div>

            {/* Alias destacado */}
            <div className="bg-gradient-to-r from-blue-600/30 to-blue-500/30 rounded-xl p-4 border border-blue-300/30">
